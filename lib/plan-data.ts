...
const special: ProductionItem[] = [
  ...
  item('0910-white', '2026-09-10', '第1集', '白模', '依据第一集剧本生成首批场景白模视频', '主美', '未开始', 3, 0, '21:00', '第一集剧本已具备，可直接按剧本制作；生成后提报Yoyo和叶总审批', 6, '', '红人（Yoyo）＋制片人（叶总）', '2026-09-11 18:00'),
  ...
  item('0911-white', '2026-09-11', '第1集', '白模', '完成并提报第一集全部场景白模视频', '主美', '未开始', 5, 0, '15:00', '依据剧本完成全部场景与调度白模，15:00同步审核材料', 8, '0910-white', '红人（Yoyo）＋制片人（叶总）', '18:00'),
  item('0911-yoyo-white', '2026-09-11', '第1集', '红人审核', '在微信审批第一集场景白模', '红人（Yoyo）', '未开始', 5, 0, '18:00', 'Yoyo不登录系统；Lipa根据微信意见更新结果', 9, '0911-white', '联合制片人／导演：Lipa', '18:15'),
